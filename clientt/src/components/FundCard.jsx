...
const remainingDays = daysLeft(deadline);
  ...
  return (
    <div className='sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pinter' onClick={handleClick}>
        ...
        <div className="flex flex-col p-4">
            ...
            <div className="flex items-center mt-[20px] gap-[12px]">
                ...
                <p className='text-[#808191] flex-1 font-epilogue font-normal text-[12px] truncate'>by <span className="text-[#b2b3bd]">{owner}</span></p>
            </div>
